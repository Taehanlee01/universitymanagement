 ...
 * @author jasuj
 */
public class gManager extends person{
 ...
 registeredIdentifyNum.clear();
    ...
    public String[] getGmanagerList(){
        String gmList[]= new String[registeredName.size()];
        System.out.println("<학생목록>");
        for(int i=0; i<registeredName.size();i++)
        {
        gmList[i] ="이름 : " + registeredName.get(i) + " 학번 : " + registeredIdentifyNum.get(i) + " 학과 : " + registeredDepartment.get(i);
        } 
        return gmList;
    }
